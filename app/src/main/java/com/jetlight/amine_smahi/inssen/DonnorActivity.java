...
public class DonnorActivity extends AppCompatActivity {
    ...
    Button btnRequest;
    String[] maintitle ={
            "Subodh Kumar","Vaishnavi Tripathi",
            "Rishu Raj","Animesh Kumar",
            "Mohammad Hussain Zaidi",
            "Krishna Mohan Yadav","Akshat Tripathi",
            "Abishek Singh","Akash Pandey",
            "Ritvik Singh",
            "vedika Shukla","Anurag Singh",
            "Shashank Singh","Srishti Kiran",
            "vidhaan Pradhan",
            "Lakshya Ahlawat","Vikas Dubey",
            "Anvesha","Abhinav",
            "Anant",
    };
